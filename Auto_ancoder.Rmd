...
```{r}
rm(list=ls(all=T))
setwd("C:\\Users\\Manjunath Purma\\Downloads\\hacker earth\\d17428d0-e-Criminal")
#setwd("C:\\Users\\rkarupas.ORADEV\\Desktop\\insofe data\\Insofe\\CUTe on Machine Learning")
